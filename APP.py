...
st.sidebar.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSlHtPd92E6sIjo2V1mKBsGc1BCffJkV-82g&usqp=CAU")
...
if user_menu == 'Overall Analysis':
    ...
    fig = px.line(nations_over_time, x="Year", y='NOC')
